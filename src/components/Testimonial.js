...
const Testimonial = (props) =>{
    ...
    function surpriseHandler(){
        let randomIndex = Math.floor(Math.random() * reviews.lengh);
    ...
    return(
        <div className="w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-500 hover:shadow-xl rounded-md">
            ...
            <div className="flex text-3xl gap-3 mt-10 text-violet-400 font-bold mx-auto">
               ...
               <div className="mt-6">
               <button 
               onClick={surpriseHandler}className="bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointer px-10 py-2 rounded-md font-bold text-white text-lg">
                   Surprise me
               </button>
               </div>      
        </div>
